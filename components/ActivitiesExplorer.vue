...
<template>
  <div class="options">
    ...
    <select v-model="selectedOrder" @change="$emit('orderSelected', selectedOrder)">
      <option disabled selected>{{defaultOrder}}</option>
      <option v-for="filter in orders" :key="filter" :value="filter">{{ filter }}</option>
    </select>
  </div>
